...
total_horas = input('Quantas horas em média você costuma estudar? ')

# 4. Crie uma variável chamada "curso" e, usando o método input(), solicite o título do curso desejado;
curso = input('Qual dos cursos você está inscrito no momento? ')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, durante mais ou menos {total_horas} diárias. Isso significa que você estuda em média {total_horas*total_dias} horas por semana para o curso: {curso}.')